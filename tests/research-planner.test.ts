...
const sourceProfile: SourceProfile = {
  ...
  redFlags: [],
  unresolvedQuestions: [],
  lowDataReasons: ["Fixture does not include live profile evidence."],
  confidenceImpact: "none",
  confidenceImpactReason: "The fixture does not add confidence to the source post.",
  confidence: 0.6,
};
